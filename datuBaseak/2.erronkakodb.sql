...
CREATE TABLE `bezeroahistorikoa` (
  ...
  `helbideElektronikoa` varchar(45) DEFAULT NULL,
  `helbidea` longtext,
...
INSERT INTO `bezeroahistorikoa` VALUES (34,'34364283Y','Hodei','Etxeberria','676445299','hodeietxebeazurmen@gmail.com','Aita Larramendi Kalea 25, 5A','Hodetxe','1234','2025-02-11 10:36:41','DELETE');
...
-- Dump completed on 2025-02-11 11:38:23
