...
public class insertBez extends JFrame {
	...
	public insertBez(erabiltzailea era) {
		...
		JLabel lblNewLabel_2 = new JLabel("Insert bezeroak");
		...
		helbideElektr.setBounds(578, 460, 280, 44);
		...
		lblHelbideElektr.setBounds(578, 422, 205, 40);
		panel.add(lblHelbideElektr);
		
		JButton Insert = new JButton("Insert");
		Insert.setBounds(578, 515, 161, 44);
		panel.add(Insert);
	...
	public void insertProduktua() {
		...
		try {
			...
			String sql = "INSERT INTO bezeroa (nan, izena, abizena, telefonoa, helbidea, erabiltzaileIzena, pasahitza, helbideElektronikoa) Values (?,?,?,?,?,?,?,?)";
			...
			JOptionPane.showMessageDialog(this, "Bezeroa ongi gehitu da!", "Ondo joan da", JOptionPane.INFORMATION_MESSAGE);
			nan.setText("");
			izena.setText("");
			abizena.setText("");
			telefonoa.setText("");
			...
			JOptionPane.showMessageDialog(this, "Errorea " + ex.getMessage() + " bezeroa sartzean:", "Errorea", JOptionPane.ERROR_MESSAGE);
		}
	}
	private void atera() {
		System.exit(0);
