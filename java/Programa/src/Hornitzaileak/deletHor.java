...
public class deletHor extends JFrame {
	 ...
	 * Create the frame.
	 */
	public deletHor(erabiltzailea era) {
		...
		JLabel lblNewLabel_2 = new JLabel("Ezabatu/Aldatu hornitzaileak");
		lblNewLabel_2.setBounds(21, 7, 417, 49);
		panel_1_1.add(lblNewLabel_2);
		lblNewLabel_2.setFont(new Font("Roboto", Font.BOLD, 30));
		
		JLabel lblNewLabel = new JLabel("Aldatu edo ezabatu nahi duzun hornitzailearen Id-a jarri:");
		lblNewLabel.setFont(new Font("Roboto", Font.BOLD, 20));
		lblNewLabel.setBounds(10, 86, 518, 51);
	...
	public void deleteHornitzailea() {

		String idAukera = idAukeratu.getText();
		
		if (idAukera.isEmpty()) {
			JOptionPane.showMessageDialog(this, "Ez duzu hornitzailerik aukeratu", "Errore bat izan da", JOptionPane.ERROR_MESSAGE);
		}
		...
		try {
			...
			JOptionPane.showMessageDialog(this, "Hornitzailea ezabatzean arazo bat egon da.", "Errorea", JOptionPane.ERROR_MESSAGE);
		}
	...
	public void aldatuHornitzailea() {
		...
		try {
			Connection connection_ = k.getConnection_();
			conn = konexioa.getConnection_();
			String sql = "UPDATE hornitzailea set nan=? , izena=?, abizena=?, telefonoa=?, helbidea=?, erabiltzaileIzena=?, pasahitza=? where idHornitzailea=?";
			PreparedStatement pst = conn.prepareStatement(sql);
			...
			JOptionPane.showMessageDialog(this, "Hornitzailea aldatzean arazo bat egon da.", "Errorea", JOptionPane.ERROR_MESSAGE);
		}
